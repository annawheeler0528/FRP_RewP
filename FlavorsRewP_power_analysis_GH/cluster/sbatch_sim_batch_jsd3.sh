...
for X in $(seq "$START" "$END"); do
  ...
  sbatch /home/fslcollab40/FlavorsRewP/sbatch_sim_task1sd.sh ${X} .00021 .0003 .00001
  sleep 1

  sbatch /home/fslcollab40/FlavorsRewP/sbatch_sim_task1sd_rewp.sh ${X} .00021 .0003 .00001
  sleep 1

  sbatch /home/fslcollab40/FlavorsRewP/sbatch_sim_task2sd.sh ${X} .00021 .0003 .00001
  sleep 1

  sbatch /home/fslcollab40/FlavorsRewP/sbatch_sim_task2sd_rewp.sh ${X} .00021 .0003 .00001
  sleep 1
