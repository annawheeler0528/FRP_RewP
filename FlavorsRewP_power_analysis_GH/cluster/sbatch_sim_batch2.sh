...
for X in $(seq "$START" "$END"); do
  ...
  sbatch /home/fslcollab40/FlavorsRewP/sbatch_sim_task1.sh ${X} 0.51 1 .01
  sleep 1

  sbatch /home/fslcollab40/FlavorsRewP/sbatch_sim_task1_rewp.sh ${X} 0.51 1 .01
  sleep 1

  

  sbatch /home/fslcollab40/FlavorsRewP/sbatch_sim_task2.sh ${X} 0.51 1 .01
  sleep 1

  sbatch /home/fslcollab40/FlavorsRewP/sbatch_sim_task2_rewp.sh ${X} 0.51 1 .01
  sleep 1
